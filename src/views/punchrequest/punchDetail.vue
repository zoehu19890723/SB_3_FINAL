...
<script>
  ...
  export default {
    created:function(){
      ...
      me.$store.dispatch('getPunchDetailInfo',{id : applyId}).then(
        (response)=>{
    ...
    methods : {
      cancelApply(res){
        ...
        me.$store.dispatch('cancelPunchApply',{id : applyId,reson : reson}).then(
          (response) =>{
            if(response.body.status === 1){
      ...
      approveApply(code,res){
        ...
        me.$store.dispatch('approvePunchApply',{
          id : me.generalId,
          reson : reson,
          code : code
        }).then(
    ...
    locales: {
      ...
      en: {
        ...
        'refuse-apply' : 'Refuse',
        'approve-apply' : 'Agree',
        'leave-cancel-apply' : 'Cancel punch succeed',
        'real-leave' : 'Punch Detail',
