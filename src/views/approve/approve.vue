...
<script>
  ...
  export default {
    ...
    computed : {
      hasNotApproveList(){
        return (this.notApproveList !== undefined && this.notApproveList.length > 0) ? true : false
      },
      hasApproveList(){
        return (this.approvedList !== undefined && this.approvedList.length > 0) ? true : false
      },
      initalIndexNew(){
